...
handler.get(async (req, res) => {
  ...
  try {
    ...
    const priceSelected = req.query.price || 0;
    ...
    priceSelected ? selPriceArray = priceSelected.split(",") : selPriceArray = [0, 0]

    let min = 0;
    let max = 90000;
    if (selPriceArray) {
      min = selPriceArray[0] ? min = selPriceArray[0] : min = 0;
      max = selPriceArray[1] ? max = selPriceArray[1] : max = 9800000;
   ...
   */
    ...
    category ? selcategory = category.split(",") : []
    // console.log(11212)
