...
import ReCheckbox from 'components/ui/htmlInputElem/ReCheckbox';
 import {
  Button,
  Link,
  List,
...
const Home: NextPage = () => {
  ...
  const submitHandler = async ({ name, price, description }: IProduct) => {
        ...
        <div className={styles.container}>
          ...
          <main className={styles.main}>
           ...
           <h6> Sizes</h6>
                <ListItem>
            <ReCheckbox
              lists={sizes} //selectedChk={propCategory}
